...
const ServiceProjectManagePage = () => {
  return (
    <>
    <div>
      {/* Header */}
      ...
      <section className="bg-gray-7">
        <div className="breadcrumbs-custom box-transform-wrap context-dark">
          <div className="container">
            <h3 className="breadcrumbs-custom-title">
              Service:  Turnkey Project Management Solutions & Advisory
            </h3>
        ...
        <div className="container">
          <ul className="breadcrumbs-custom-path">
            ...
            <li className="active"> Turnkey Project Management Solutions & Advisory</li>
          </ul>
        </div>
      </section>
      {/* Services*/}
            ...
            <div className="col-md-12 col-xl-12">
              <div className="single-service">
                <img
                  ...
                  height={390}
                />
                <h4> Turnkey Project Management Solutions & Advisory</h4>
                <p>
...
export default ServiceProjectManagePage