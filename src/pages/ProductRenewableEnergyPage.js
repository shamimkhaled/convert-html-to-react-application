...
const ProductRenewableEnergyPage = () => {
  return (
    <>
      <div>
        ...
        <section className="bg-gray-7">
          <div className="breadcrumbs-custom box-transform-wrap context-dark">
            ...
            <div
              ...
              style={{
                backgroundImage:
                  "url(assets/images/products/renewable-energy-products/banner.png)",
              }}
            />
          </div>
          <div className="container">
            <ul className="breadcrumbs-custom-path">
              ...
              <li className="active">Renewable Energy Products</li>
            </ul>
          </div>
        </section>
        {/* Single Product*/}
            ...
            <div className="row row-30">
                  ...
                  >
                    <div className="item">
                      <div className="slick-product-figure">
                        <img
                          src="assets/images/products/renewable-energy-products/1.png"
                          alt=''
                          width={530}
                          height={480}
                        />
                    ...
                    <div className="item">
                      <div className="slick-product-figure">
                        <img
                          src="assets/images/products/renewable-energy-products/2.png"
                          alt=''
                          width={530}
                          height={480}
                        />
                    ...
                    <div className="item">
                      <div className="slick-product-figure">
                        <img
                          src="assets/images/products/renewable-energy-products/3.png"
                          alt=''
                          width={530}
                          height={480}
                        />
              ...
              <div className="col-lg-6">
                <div className="single-product">
                  ...
                  <p>
                    Hlela Mining &amp;Projects offers state-of-the-art Renewable
                    Energy Solutions to keep up with the growing trend of Going
                    Green.
                  </p>
                  ...
                  <ul className="list list-description d-inline-block d-md-block">
                    ...
                    <li>
                      <span>-</span>
                      <span>Cables and Cable Racking</span>
                    </li>
                    <li>
                      <span>-</span>
                      <span>
                        Solar System Package Design, Installation &amp;
                        Certification
                      </span>
                    </li>
                  </ul>
...
export default ProductRenewableEnergyPage;
