          ...
          <div className="breadcrumbs-custom box-transform-wrap context-dark">
            <div className="container">
              <h3 className="breadcrumbs-custom-title">
                tailings facility berm construction – rehabilitation
              </h3>
            ...
            <div className="row row-60 flex-lg-row-reverse">
              <div className="col-lg-6 col-xl-7">
                <div className="slick-project">
                  ...
                  >
                    <div className="item">
                      <img
                        src="assets/images/project-4-670x477.jpg"
                        alt=''
                        width={670}
                        height={477}
                      />
                  ...
                  <table className="table-custom table-custom-primary table-project">
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <span>Client:</span> South32 – Incident Management
                          Team{" "}
                        </td>
                      </tr>
                      <tr>
              ...
              <div className="col-lg-6 col-xl-5">
                <div className="project-page">
                  <h4>TAILINGS FACILITY BERM CONSTRUCTION – REHABILITATION</h4>
                  <br />
                  Incident &amp; risk management – dam structural integrity
                  assessment &amp; study
                  <br />
                  Construction of deflecting berm
                  <br />
                  Storm water management
                  <br />
                  Stakeholder management
                  <br />
                  Project planning, execution &amp; governance
                  <br />
