            ...
            <div className="row row-60 flex-lg-row-reverse">
              <div className="col-lg-6 col-xl-7">
                <div className="slick-project">
                  ...
                  >
                    <div className="item">
                      <img
                        src="assets/images/project-11-670x477.jpg"
                        alt=''
                        width={670}
                        height={477}
                      />
                  ...
                  <table className="table-custom table-custom-primary table-project">
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <span>Client:</span> Barloworld Equipment &amp;
              ...
              <div className="col-lg-6 col-xl-5">
                <div className="project-page">
                  <h4>CAT 5 DRAGLINE RELOCATION &amp; REFURBISHMENT PROJECT</h4>
                  <br />
                  Disassembly, relocation &amp; assembly of CAT 5 dragline
                  machine
                  <br />
                  Project execution planning, management &amp; senior executive
                  reporting
                  <br />
...
export default ProjectElevenPage;
