        ...
        <section className="bg-gray-7">
          ...
          <div className="container">
            <ul className="breadcrumbs-custom-path">
              ...
              <li className="active">cat 6060 rebuild project </li>
            </ul>
          </div>
        </section>
        {/* Project Page*/}
            ...
            <div className="row row-60 flex-lg-row-reverse">
              ...
              <div className="col-lg-6 col-xl-5">
                <div className="project-page">
                  <h4>CAT 6060 REBUILD PROJECT</h4>
                  <br />
                  Mid-life refurbishment project
                  <br />
                  Technical project management
                  <br />
                  Site supervision – incl. resource management
                  <br />
...
export default ProjectEightPage;
