        ...
        <section className="bg-gray-7">
          ...
          <div className="container">
            <ul className="breadcrumbs-custom-path">
              ...
              <li className="active">Standby Power Systems</li>
            </ul>
          </div>
        </section>
        {/* Services*/}
...
export default ServiceStandPowerPage;
