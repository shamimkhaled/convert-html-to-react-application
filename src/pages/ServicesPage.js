            ...
            <div className="row row-lg row-40 justify-content-center">
              <div className="col-md-6 col-lg-5 col-xl-4">
                <div className="oh">
                  ...
                  >
                    <Link className="services-classic-figure">
                      <img
                  ...
                  >
                    ...
                    <div className="services-classic-caption">
                      <div className="unit align-items-lg-center">
                        ...
                        <div className="unit-body">
                          <h5 className="services-classic-title">
                            <Link>Cost Engineering and Feasability Studies</Link>
                          </h5>
                        </div>
                      </div>
                    </div>
                  ...
                  >
                    ...
                    <div className="services-classic-caption">
                      <div className="unit align-items-lg-center">
                        ...
                        <div className="unit-body">
                          <h5 className="services-classic-title">
                            <Link>Quality Assurance &amp; Control</Link>
                          </h5>
                        </div>
                      </div>
                    </div>
                  ...
                  >
                    ...
                    <div className="services-classic-caption">
                      <div className="unit align-items-lg-center">
                        ...
                        <div className="unit-body">
                          <h5 className="services-classic-title">
                            <Link>Detailed Design &amp; Engineering</Link>
                          </h5>
                        </div>
                      </div>
                    </div>
                  ...
                  >
                    ...
                    <div className="services-classic-caption">
                      <div className="unit align-items-lg-center">
                        ...
                        <div className="unit-body">
                          <h5 className="services-classic-title">
                            <Link>Standby Power Systems</Link>
                          </h5>
                        </div>
                      </div>
                    </div>
