            ...
            <div className="row row-60 flex-lg-row-reverse">
              <div className="col-lg-6 col-xl-7">
                <div className="slick-project">
                  ...
                  >
                    <div className="item">
                      <img
                        src="assets/images/project-9-670x477.jpg"
                        alt=''
                        width={670}
                        height={477}
                      />
                  ...
                  <table className="table-custom table-custom-primary table-project">
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <span>Client:</span> South32 (now Seriti Power){" "}
                        </td>
                      </tr>
                      <tr>
                        <td>
              ...
              <div className="col-lg-6 col-xl-5">
                <div className="project-page">
                  <h4>SHOVEL SHUTDOWN &amp; REFURBISHMENT PROJECTS</h4>
                  <br />
                  Several face shovel shutdown &amp; major refurb projects
                  <br />
...
export default ProjectNinePage;
