          ...
          <div className="breadcrumbs-custom box-transform-wrap context-dark">
            <div className="container">
              <h3 className="breadcrumbs-custom-title">
                waterval smelter – scf1 &amp; slag granualtion upgrade
                pre-feasibility
              </h3>
            ...
            <div className="row row-60 flex-lg-row-reverse">
              ...
              <div className="col-lg-6 col-xl-5">
                <div className="project-page">
                  ...
                  <br />
                  Pre-feasibility Study – Upgrade of auxiliary systems
                  <br />
                  Development of pre-feasibility study report
