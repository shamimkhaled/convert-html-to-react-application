            ...
            <div className="row row-60 flex-lg-row-reverse">
                  ...
                  <table className="table-custom table-custom-primary table-project">
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <span>Client:</span> South32 – Mine Closure Operations{" "}
                        </td>
                      </tr>
                      <tr>
                        <td>
              ...
              <div className="col-lg-6 col-xl-5">
                <div className="project-page">
                  ...
                  <br />
                  Pre-feasibility Study – Potential land use options
                  <br />
                  Develop mine closure project framework
                  <br />
                  Project planning, schedule &amp; budget governance
                  <br />
                  Integrated dashboard reporting
                  <br />
                  Study execution close-out report
