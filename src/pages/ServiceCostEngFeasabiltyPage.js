...
const ServiceCostEngFeasabiltyPage = () => {
  return (
    <>
    <div>
      {/* Header */}
      ...
      <section className="bg-gray-7">
        <div className="breadcrumbs-custom box-transform-wrap context-dark">
          <div className="container">
            <h3 className="breadcrumbs-custom-title">
              Service:   Cost Engineering and Feasability Studies
            </h3>
        ...
        <div className="container">
          <ul className="breadcrumbs-custom-path">
            ...
            <li className="active">  Cost Engineering and Feasability Studies</li>
          </ul>
        </div>
      </section>
      {/* Services*/}
            ...
            <div className="col-md-12 col-xl-12">
              <div className="single-service">
                <img
                  ...
                  height={390}
                />
                <h4> Cost Engineering and Feasability Studies</h4>
                <p>
...
export default ServiceCostEngFeasabiltyPage